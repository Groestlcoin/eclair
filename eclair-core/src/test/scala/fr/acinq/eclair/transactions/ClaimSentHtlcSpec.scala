...
class ClaimSentHtlcSpec extends FunSuite {
  ...
  object Alice {
    val (commitKey, true) = PrivateKey.fromBase58("cVuzKWCszfvjkoJyUasvsrRdECriz8hSd1BDinRNzytwnXm871Jd", Base58.Prefix.SecretKeyTestnet)
    val (finalKey, true) = PrivateKey.fromBase58("cRUfvpbRtMSqCFD1ADdvgPn5HfRLYuHCFYAr2noWnaRDNggXqRQ2", Base58.Prefix.SecretKeyTestnet)
  ...
  object Bob {
    val (commitKey, true) = PrivateKey.fromBase58("cSupnaiBh6jgTcQf9QANCB5fZtXojxkJQczq5kwfSBeULjNzTw8R", Base58.Prefix.SecretKeyTestnet)
    val (finalKey, true) = PrivateKey.fromBase58("cQLk5fMydgVwJjygt9ta8GcUU4GXLumNiXJCQviibs2LE5wc96zf", Base58.Prefix.SecretKeyTestnet)
    val commitPubKey = commitKey.publicKey
    val finalPubKey = finalKey.publicKey
